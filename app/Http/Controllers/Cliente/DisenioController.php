...
class DisenioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'canvas_json'            => 'nullable|string|max:500000',
            ...
            'imagen_captura'  => 'nullable|string|max:7000000', // viene como data:image/png;base64,.... (~5MB decodificado)
            'imagen_3d_frente'=> 'nullable|string|max:7000000',
            'imagen_3d_atras' => 'nullable|string|max:7000000',
