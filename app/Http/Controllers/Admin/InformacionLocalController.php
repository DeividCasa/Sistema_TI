...
class InformacionLocalController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'categoria_uniforme_imagen' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:4096',
            'categoria_chompa_imagen'   => 'nullable|image|mimes:jpg,jpeg,png,webp|max:4096',
            'categoria_ropa_imagen'     => 'nullable|image|mimes:jpg,jpeg,png,webp|max:4096',
