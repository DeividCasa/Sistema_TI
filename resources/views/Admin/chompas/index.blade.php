...
<div class="admin-header">
    <div class="admin-title">
        Chompas
        <span class="admin-badge">{{ $chompas->count() }} registradas</span>
    </div>
    <a href="{{ route('admin.chompas.create') }}" class="btn-new">
...
@if($chompas->isEmpty())
    <div class="empty-card">
        ...
        <p style="color: var(--text-2);">Aún no hay chompas registradas. Crea la primera con el botón "Nueva chompa".</p>
    </div>
@else
        ...
        @foreach($chompas as $chompa)
            <div class="plantilla-card">
                ...
                <div class="plantilla-info">
                    ...
                    <div class="acciones">
                        <a href="{{ route('admin.chompas.edit', $chompa->id) }}" class="btn-edit">Editar</a>
                        <form action="{{ route('admin.chompas.destroy', $chompa->id) }}" method="POST"
                              onsubmit="return confirm('¿Seguro que deseas eliminar esta chompa?');" style="display: inline-block;">
                            @csrf
                            @method('DELETE')
