        ...
        <table role="presentation" width="420" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:16px; overflow:hidden; border:1px solid #E2E8F0;">
          ...
          <tr>
            <td style="padding:32px;">
              ...
              <h1 style="margin:0 0 14px; font-size:20px; color:#1E293B; font-weight:800;">Tu código de acceso</h1>
              <p style="margin:0 0 22px; font-size:14px; color:#64748B; line-height:1.6;">
                Usa el siguiente código para completar el inicio de sesión en el panel de administración. Este código vence en 10 minutos.
              </p>
              ...
              <p style="margin:0; font-size:12.5px; color:#94A3B8; line-height:1.6;">
                Si no intentaste iniciar sesión, ignora este correo o cambia tu contraseña de inmediato.
              </p>
            </td>
          </tr>
        </table>
