...
@php
  ...
  foreach ($carritoPlantillas as $key => $item) {
    $filas[] = [
      'nombre' => $item['nombre'], 'imagen' => $item['imagen'] ?? null,
  ...
  foreach ($carrito as $key => $item) {
    $filas[] = [
      'nombre' => $item['nombre'], 'imagen' => $item['imagen'],
  ...
  $carritoVacio = empty($carrito) && empty($carritoUniformes) && empty($carritoPlantillas);
...
<div class="container">
  <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
    ...
    <span class="stext-109 cl4">Mi carrito de chompas</span>
  </div>
</div>
...
@if($carritoVacio)
  <div class="container p-t-60 p-b-100 txt-center">
    ...
    <p class="stext-102 cl6 p-t-20">Tu carrito está vacío. Ve al catálogo de chompas y elige la tuya.</p>
    <a href="{{ route('cliente.catalogo.index', ['categoria' => 'chompa']) }}" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04" style="margin:24px auto 0;">
      Ir al catálogo
    </a>
  </div>
@else
        ...
        <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
          <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
            ...
            <div class="flex-w flex-t bor12 p-b-13">
              ...
              <div class="size-209"><span class="mtext-110 cl2">${{ number_format($totalMostrado, 2) }}</span></div>
            </div>

            <div class="flex-w flex-t bor12 p-t-15 p-b-15">
              <div class="size-208"><span class="stext-110 cl2">Adelanto requerido (50%):</span></div>
              <div class="size-209"><span class="mtext-110" style="color:var(--blue);">${{ number_format($adelantoMostrado, 2) }}</span></div>
            </div>

            <div class="flex-w flex-t p-t-15 p-b-27">
              <div class="size-208"><span class="stext-110 cl2">Saldo al recibir:</span></div>
              <div class="size-209"><span class="mtext-110 cl2">${{ number_format($saldoMostrado, 2) }}</span></div>
            </div>
            ...
            <a href="{{ route('cliente.catalogo.index', ['categoria' => 'chompa']) }}" class="stext-107 cl6 hov-cl1 trans-04" style="display:block;text-align:center;margin-top:16px;">
              ← Seguir comprando
            </a>
          </div>
        </div>
